...
const SongDetail = () => {
  ...
  return (
    <div className="px-8 pt-10 pb-32 text-white bg-gradient-to-b from-primary/5 to-transparent">
      ...
      <div className="flex flex-col md:flex-row md:items-end gap-10">
        ...
        <div className="flex flex-1 flex-col justify-end gap-6 pb-2">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button
              onClick={handlePlay}
              className="flex h-12 min-w-[140px] items-center justify-center gap-2 rounded-full bg-primary px-8 font-bold text-black shadow-lg shadow-primary/20 hover:bg-hover transition-all active:scale-95"
            >
            ...
            {/* Add */}
            <button className="flex h-12 w-12 items-center justify-center rounded-full bg-[#27313a] border border-[#3a4955] text-white hover:bg-[#3a4955] transition">
            ...
            {/* Favorite */}
            <button className="flex h-12 w-12 items-center justify-center rounded-full text-gray-400 hover:text-white transition">
              <span className="material-symbols-outlined text-2xl">
                favorite
              </span>
            </button>
      ...
      <div className="mt-16">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-sm font-bold text-gray-400 hover:text-primary uppercase tracking-wider">
            Show All
          </button>
        </div>
