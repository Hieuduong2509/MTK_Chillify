...
const ProgressBar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-24 bg-[#0f172a] px-6 flex items-center justify-between z-50">
      ...
      <div className="flex items-center gap-4 w-1/4 min-w-[220px]">
        ...
        <span className="material-symbols-outlined text-gray-400 text-xl cursor-pointer hover:text-white transition">
          favorite_border
        </span>
      </div>
      ...
      <div className="flex flex-col items-center w-2/4 max-w-2xl">
        ...
        <div className="flex items-center gap-6 mb-2">
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-md disabled:opacity-40"
          >
          ...
          <button
            ...
            className={`transition ${
              isRepeat ? "text-blue-500" : "text-gray-400 hover:text-white"
            }`}
          >
            <span className="material-symbols-outlined text-xl">
              repeat_one
